  ...
  return (
    <div className="relative max-w-[2400px] mx-auto -z-10">
      <div className="relative bottom-80 max-2xl:bottom-20 max-sm:bottom-10">
        ...
        <div className="absolute transform top-[53%] -translate-y-1/2 left-40 max-2xl:left-14 max-sm:left-10 flex flex-col gap-5 max-sm:gap-1 text-white z-10">
        ...
        <div className="text-white flex gap-10 px-10 absolute bottom-[-8%] 4xl:bottom-44 max-2xl:hidden z-10">
        ...
        <div className="scale-50 max-2xl:scale-75 -z-50">
          <WhiteRound />
        </div>
      </div>
